...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.MyNotificationHolder> {
    ...
    SubscriptionplansActivity parent;
    private Context con;
    private String dt;
    ...
    public MyNotificationHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        View vw = inflater.inflate(R.layout.items_savedaddress, parent, false);
...
//        }
        ...
        myHolder.medicineHeading.setText(category_Position.getFlatNumber());
        myHolder.deliver_street.setText(category_Position.getStreet()+" "+category_Position.getState());
        myHolder.medicine_price.setText("$"+category_Position.getAddressType());
        myHolder.deliver_address_type.setText(category_Position.getLandmark());
        myHolder.deliver_landmark.setTag("$"+category_Position.getState());
    }
...
//            itemView.setOnClickListener(this);
            ...
            medicineHeading = (TextView) itemView.findViewById(R.id.tv_flat_address_heading);
            deliver_street = (TextView) itemView.findViewById(R.id.tv_address_street);
            deliver_landmark = (TextView) itemView.findViewById(R.id.tv_landmark);
